...
2. \(D=6,\;s=2\): far-zone stable circulars excluded; global near/intermediate-zone bound classification remains open.
...
- unresolved sectors explicitly isolated (\(D\ge 6\) multi-spin global closure).
