...
82. [next] Execute AN-25: widen AN-24 compact-support local observable/test classes to a broader local class in the same \(d=3\) branch before oscillatory/de-regularized lift.
