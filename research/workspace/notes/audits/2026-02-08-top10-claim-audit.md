...
103. [next] Execute AN-33L-B: prove projective-defect/de-regularization transfer lemmas using the new exhaustion pairwise wrappers, then sync Paper 3 reconstruction-facing assumptions.
