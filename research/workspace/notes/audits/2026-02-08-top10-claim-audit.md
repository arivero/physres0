...
|---|---:|---|
| 1 | 9.1 | Scoped theorem package now includes manuscript-integrated non-factorized quadratic-mixing/quartic-tail large-\(N\) extensions plus a first-order non-Gaussian multi-mode quartic closure; global non-perturbative continuum interacting equivalence remains open. |
...
42. [next] Upgrade the new multi-mode quartic sector from first-order to non-perturbative (finite-\(g\)) large-\(N\) control.
