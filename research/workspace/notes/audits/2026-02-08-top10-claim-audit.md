...
| 9 | Gauge-theory long-range taxonomy with explicit \((G,D)\) dependencies (Coulomb/log/linear/screened) | `conv_patched.md:619`, `conv_patched.md:633`, `conv_patched.md:647` | `heuristic` | Phase/model split was formalized in `research/workspace/notes/theorems/2026-02-08-claim9-gauge-long-range-phase-split.md` and `research/workspace/notes/theorems/2026-02-08-claim9-model-class-propositions.md`; the screened Abelian branch \((G=U(1),D)\) is theorem-closed in `research/workspace/notes/theorems/2026-02-09-claim9-abelian-screened-theorem.md`. The non-Abelian confining lane now has both scoped extraction-theorem closure (`research/workspace/notes/theorems/2026-02-09-claim9-nonabelian-arealaw-linear-program.md`) and a scoped derivation of its area-law/perimeter hypothesis package in an explicit strong-coupling \(SU(N)\) lattice window (`research/workspace/notes/theorems/2026-02-09-claim9-nonabelian-strong-coupling-window-derivation.md`). Remaining gaps are beyond-window/continuum extension and full string-breaking crossover theorems. | Extend the strong-coupling derivation lane beyond the current window (or tie to continuum transfer assumptions), then close dynamical-matter crossover rigor. |
...
| 9 | 7.8 | Screened Abelian branch is theorem-closed with explicit asymptotics; non-Abelian confining branch now has scoped finite-\(T\) extraction theorem closure plus a scoped strong-coupling derivation of its area-law/perimeter hypothesis package in an explicit \((SU(N),D)\) model window. Beyond-window/continuum transfer and dynamical-matter crossover rigor remain open. |
...
91. [next] Execute AN-31: extend AN-30 from finite graph-indexed families to uniformly locally finite exhaustion families with summability-weighted combinatorial constants.
92. [queued] Claim 9 non-Abelian next lane: extend strong-coupling-window derivation toward broader coupling/continuum transfer assumptions and then tighten dynamical-matter string-breaking rigor.
