...
105. [next] Newton-limit paradox support: formalize semigroup/normalization theorems (Gaussian kernel `t^{-d/2}` normalization, semigroup→generator) and connect them to the amplitude/half-density necessity framing.
