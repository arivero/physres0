...
| 9 | Gauge-theory long-range taxonomy with explicit \((G,D)\) dependencies (Coulomb/log/linear/screened) | `conv_patched.md:619`, `conv_patched.md:633`, `conv_patched.md:647` | `heuristic` | Phase/model split was formalized in `research/workspace/notes/theorems/2026-02-08-claim9-gauge-long-range-phase-split.md` and `research/workspace/notes/theorems/2026-02-08-claim9-model-class-propositions.md`; the screened Abelian branch \((G=U(1),D)\) is theorem-closed in `research/workspace/notes/theorems/2026-02-09-claim9-abelian-screened-theorem.md`. The non-Abelian confining lane now has scoped extraction-theorem closure, scoped strong-coupling derivation of its area-law/perimeter hypothesis package, and a scoped beyond-window \(\beta\)-transfer theorem lane (`research/workspace/notes/theorems/2026-02-09-claim9-nonabelian-beyond-window-transfer-assumptions.md`). Remaining gaps are first-principles transfer control and full string-breaking crossover theorems. | Convert the scoped transfer lane into first-principles control beyond strong coupling, then close dynamical-matter crossover rigor. |
...
| 9 | 8.1 | Screened Abelian branch is theorem-closed with explicit asymptotics; non-Abelian confining branch now has scoped finite-\(T\) extraction theorem closure, scoped strong-coupling derivation of its area-law/perimeter package, and a scoped beyond-window \(\beta\)-transfer theorem lane. First-principles transfer control and dynamical-matter crossover rigor remain open. |
...
93. [next] Execute AN-32: extend AN-31 from cylinder observables to weighted-local SD-test classes with explicit exhaustion-uniform insertion estimates.
94. [queued] Claim 9 non-Abelian next lane: replace scoped transfer assumptions with first-principles beyond-window control and tighten dynamical-matter string-breaking rigor.
