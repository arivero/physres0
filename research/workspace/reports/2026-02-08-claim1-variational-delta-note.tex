...
This is \emph{not} the derivative distribution $\delta'$ of Dirac.
...
\section{Half-Density Interpretation and Open Step}

The ``halved'' amplitude viewpoint is:
\begin{itemize}[leftmargin=1.4em]
\item amplitudes behave as half-density-level objects,
