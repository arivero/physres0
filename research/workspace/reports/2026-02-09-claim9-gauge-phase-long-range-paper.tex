...
that derivation beyond the strong-coupling window and closing dynamical-matter
string-breaking rigor.
\end{abstract}
...
\hline
\((SU(N),\ \text{none},\ \text{confining})\) & explicit \((G,D)\), finite-window \(r,T\), plus strong-coupling derivation lane & linear extraction with \(O(T^{-1})\) bounds & scoped theorem + scoped derivation \\
\hline
...
assumptions are now derived in a scoped strong-coupling lattice window.
The remaining open gaps are extending this derivation beyond the strong-coupling
window and proving full dynamical-matter string-breaking crossover theorems.
\end{corollary}
...
a scoped strong-coupling lattice window.
Extending the derivation beyond that window and closing string-breaking with
dynamical matter remain open.
...
derivation lane now grounded in an explicit strong-coupling lattice model.
Extending beyond that window and full string-breaking crossover remain explicit
