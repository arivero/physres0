...
\begin{enumerate}
\item extend AN-27 from strictly local blocks to a first nonlocal-cylinder observable family (AN-28) in the same \(d=3\) channel,
\item keep non-vanishing/envelope assumptions explicit while widening this scope.
\end{enumerate}
...
AN-27 closes oscillatory/de-regularized transfer in that scoped branch under
explicit assumptions. Full nonlocal and global continuum interacting closure
remains open.
