...
It further closes:
(vi) a genuinely large-$N$ mode-coupled lift with explicit Cauchy tail rate,
...
\item Theorem \ref{thm:largen-coupled}: large-$N$ coupled extension with explicit tail rate.
...
\item large-$N$ mode-coupled convergence with quantitative tail control,
