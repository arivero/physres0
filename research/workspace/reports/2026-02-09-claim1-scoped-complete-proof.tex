...
\item Theorems \ref{thm:largen-coupled} and \ref{thm:quartic-tail}: large-$N$ coupled extensions (Gaussian-tail explicit rate and non-factorized quartic-tail class).
...
\item large-$N$ mode-coupled convergence with quantitative tail control (Gaussian-tail and non-factorized quartic-tail classes),
